...
export const BulkOperationModal = () => {
    ...
    const isModalOpen = isOpen && type === "bulk:operation";
    ...
    return (
        <Dialog open={isModalOpen} onOpenChange={handleClose}>
            <DialogContent className="text-black min-h-[320px]">
                <DialogHeader className="pt-6">
                    <DialogTitle className="text-2xl text-center font-bold">
                        Bulk Operation {formName}
                    </DialogTitle>
                </DialogHeader>
                <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full">
                                    <FormLabel>Select employee to assign leads</FormLabel>
                                    <MultiSelector
